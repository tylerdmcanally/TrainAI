...
import { ArrowLeft, Clock, FileText, Video, ListChecks } from 'lucide-react'
...
import { LazyVideoPlayer } from '@/components/training/lazy-components'

// Loading component for lazy-loaded components
const LoadingSpinner = () => (
  <div className="flex items-center justify-center p-8">
    <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600"></div>
    <span className="ml-2 text-gray-600">Loading video player...</span>
  </div>
)

export default async function OptimizedTrainingDetailPage({
  params,
}: {
  params: { id: string }
}) {
    ...
    <DashboardLayout>
      <div className="p-8 max-w-6xl mx-auto">
        ...
        <div className="mt-8 p-4 bg-blue-50 rounded-lg">
          <p className="text-sm text-blue-800">
            🚀 <strong>Optimized Loading:</strong> The video player is lazy-loaded to reduce 
